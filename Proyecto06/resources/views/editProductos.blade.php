            ...
            <form method="POST" action="{{ route('productos.update', $producto->id) }}">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="name" id="name"
                        ...
                        required value="{{ $producto->nombreProducto }}" />{{ $producto->nombreProducto }}
                </div>
                <div class="mb-5">
                    <label for="productDescription" class="mb-3 block text-base font-medium text-[#07074D]">
                        Descripción del Producto
                    </label>
                    <textarea name="productDescription" id="productDescription" placeholder="{{ $producto->descripcionProducto }}"
                ...
                <div class="mb-5" style="width: 150px">
                    ...
                    <input type="number" name="price" id="price"
                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                        required value="{{ $producto->precioUnitario }}" />
                </div>
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="number" name="stockMin" id="stockMin"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                required value="{{ $producto->stockMin }}" />
                        </div>
                    </div>
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                ...
                <div class="mb-5 pt-3">
                    ...
                    <div class="-mx-3 flex flex-wrap">
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                <label for="proveedorHabitual" class="mb-3 block text-base font-medium text-[#07074D]">
                                    Proveedor habitual </label> <select name="proveedorHabitual" id="proveedorHabitual">
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                <label for="categoriaProducto" class="mb-3 block text-base font-medium text-[#07074D]">
                                    Categoria producto </label> <select name="categoriaProducto" id="categoriaProducto">
