...
background: linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(144,147,85,1) 100%);">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="https://flowbite.com" class="flex items-center">
                    <img src="{{ asset('storage/assets/photos/logo.png') }}"class="mr-3 sm:h-50" alt="Flowbite Logo"
                        style="height: 10vh" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">GoldLions</span>
                </a>
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="/visitas"
                                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Visitas</a>
                        </li>
                        <li>
                            <a href="#"
                        ...
                        <li>
                            <a href="#"
                                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Competiciones</a>
                        </li>
                        <li>
                            <a href="#"
    ...
    position: relative;">
        <div class="promo"
            style="padding-top: -65px;display: flex;flex-direction: column;justify-content: center;align-items: center;width: 60%;margin: auto;position: relative;z-index: 2;">
            <section class="text-gray-600 body-font">
                <div class="container mx-auto flex  items-center justify-center flex-col">
                    <img src="{{ asset('storage/assets/photos/logo.png') }}"class="mr-3 " alt="Flowbite Logo"
                        style="height: 60vh;" />
                    <div class="text-center lg:w-2/3 w-full">
                        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-yellow-500">Desafía tus límites
                            y
                            descubre la fuerza que reside dentro de ti. ¡Es hora de iniciar tu viaje!</h1>
                        <p class="mb-8 leading-relaxed text-white text-opacity-100 text-2xl">¡Únete hoy y
                            descubre un
                            mundo de
                            beneficios
                            exclusivos para
                            nuestros nuevos socios! ¡No te pierdas nuestras promociones especiales!</p>
                        <div class="flex justify-center">
                            <button
                                class="inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg">¡DESCUBRE!</button>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <video muted autoplay loop type="video/mp4"
            src="{{ asset('storage/assets/videos/production_id_4761421 (2160p).mp4') }}"
